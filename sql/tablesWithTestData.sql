...
-- Zrzucanie danych dla tabeli project.activity: ~0 rows (około)
INSERT INTO `activity` (`activity_id`, `activity_name`, `lights_level`, `temperature`, `planned`) VALUES
	(1, 'cos', 10, 24, NULL);
...
-- Zrzucanie danych dla tabeli project.animal: ~0 rows (około)
...
-- Zrzucanie danych dla tabeli project.aquarium: ~0 rows (około)
INSERT INTO `aquarium` (`aquarium_id`, `aquarium_name`, `aquarium_length`, `aquarium_width`, `aquarium_height`, `aquarium_volume`, `user_id`, `activity_id`) VALUES
	(1, 'akwarium1', 12.00, 12.00, 12.00, 1728.00, 1, NULL),
	(2, 'Akwarium2', 12.00, 11.20, 15.00, 1758.00, 1, 1);
...
-- Zrzucanie danych dla tabeli project.species: ~0 rows (około)
...
-- Zrzucanie danych dla tabeli project.user: ~0 rows (około)
